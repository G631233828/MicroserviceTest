package zhongchiedu.com.shiro.config;
...
public class ShiroConfig {
	...
	public ShiroFilterFactoryBean ShiroFilter(SecurityManager securityManager) {
		...
		filterChainDefinitionMap.put("/admin/tologin", "user,addPrincipal");
		filterChainDefinitionMap.put("/admin/index", "user,addPrincipal");
		filterChainDefinitionMap.put("/admin/toindex", "user,addPrincipal");
